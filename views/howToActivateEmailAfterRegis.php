                         ...
                         <div class="row">
                              ...
                              <div class="jumbotron">
                                   <div class="well" style="text-align: center;">
                                       ...
                                       <h2 style="color: #fff;"><?= $langClass->translate($lang, 'howToActivateEmailAfterRegis.php', 'checkSpam') ?></h2>
                                       <h2 style="color: #fff;"><?= $langClass->translate($lang, 'howToActivateEmailAfterRegis.php', '24hoursValid') ?></h2>
                                        <p>&nbsp;&nbsp;</p>
                                   </div>
                                   <p style="color:var(--nlm-blue);font-weight:bold;"><?= $langClass->translate($lang, 'howToActivateEmailAfterRegis.php', 'anyProblems') ?></p>
                              </div>
                         </div>
                    </div>
               </section>
